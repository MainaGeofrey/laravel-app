    ...
    <div class="xl:px-20 md:px-10 sm:px-6 px-4 md:py-12 py-9 2xl:mx-auto 2xl:container md:flex items-center justify-center">
        ...
        <div class="bg-white shadow-lg rounded xl:w-1/3 lg:w-5/12 md:w-1/2 w-full lg:px-10 sm:px-6 sm:py-10 px-2 py-6">
            ...
            <form method="POST" action="{{ route('register') }}">
                ...
                <div>
                    <label for="name" class="text-sm font-medium leading-none text-gray-800"> Name </label>
                    <input id="name" name="name" aria-labelledby="name" type="text" class="bg-gray-200 border rounded text-xs font-medium leading-none  text-gray-800 py-3 w-full pl-3 mt-2
                            @error('name') is-invalid @enderror" :value="old('name')" placeholder="{{ 'john' }}" required autocomplete="name" autofocus />
                ...
                <div>
                    ...
                    <input id="email" name="email" aria-labelledby="email" type="email" class="bg-gray-200 border rounded text-xs font-medium leading-none  text-gray-800 py-3 w-full pl-3 mt-2
                            @error('email') is-invalid @enderror" :value="old('email')" placeholder="{{ 'e.g john@email.com' }}" required autocomplete="email" autofocus />
                ...
                <div class="mt-6 w-full">
                    <label for="myInput" class="text-sm font-medium leading-none text-gray-800"> {{ __('Password') }} </label>
                    <div class="relative flex items-center justify-center">
                        <input id="password" name="password" type="password" class="bg-gray-200 border rounded text-xs font-medium leading-none text-gray-800 py-3 w-full pl-3 mt-2
                            @error('password') is-invalid @enderror" placeholder="{{ __('Password') }}"  required autocomplete="new-password"/>
                ...
                <div class="mt-6 w-full">
                    <label for="myInput" class="text-sm font-medium leading-none text-gray-800"> {{ __('Confirm Password') }} </label>
                    <div class="relative flex items-center justify-center">
                        <input id="password-confirm" name="password_confirmation" type="password" class="bg-gray-200 border rounded text-xs font-medium leading-none text-gray-800 py-3 w-full pl-3 mt-2
                            @error('password-confirm') is-invalid @enderror" placeholder="{{ __('Password') }}"  required autocomplete="new-password"/>
                    </div>
                </div>
